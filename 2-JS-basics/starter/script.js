...
// // typeof operator (give the nature)
...
//     break;
//   case 'driver':
//     console.log(firstName + 'teaches kids how to drive');
//     break;
//   case 'designer':
//     console.log(firstName + 'teaches kids how to design websites');
//     break
//   default:
...
// truhty values: NOT falsy values
...
winner to the console. HINT: you will need the && operator to take the decision. If you can't solve
this one, just watch the solution, it's no problem. :)
5. Like before, change the scores to generate different winners, keeping in mond there might be draws.

GOOD LUCK
*/

// var johnTeam = (89 + 120 + 103) / 3;
// var mikeTeam = (116 + 94 + 323) / 3;
// var maryTeam = (97 + 134 + 105) / 3;

// console.log(johnTeam, mikeTeam, maryTeam)

// if (johnTeam > mikeTeam && maryTeam) {
//   console.log('With ' + johnTeam + ' points, the John\'s team has win');
// } else if (mikeTeam > johnTeam && maryTeam) {
//   console.log('With ' + mikeTeam + ' points, the Mike\'s team has win');
// } else if (maryTeam > johnTeam && mikeTeam) {
//   console.log('With ' + maryTeam + ' points, the Mary\'s team has win');
// } else {
//   console.log('No winner today... Well done guys!');
// }
...
//   } else {
//     console.log(firstName + ' is aleready retired.');
//   }
// }
...
// john.push('blue'); // add element ah the end of the array
// john.unshift('Mr'); // add element ah the beginning of the array
// console.log(john);

// john.pop(); // removes element from the end
// john.pop(); // removes yet an element from the end
// john.shift(); // removes element from the beginning
// console.log(john);



// console.log(john.indexOf(1990)); // return the position of the element
...
(NOTE: To calculate 20% of a value, simply mutiply if with 20/100 = 0.2)
...
/*
Let's remember the first coding challenge where Mark and John compared their BMI's.
...
3. In the end, log to the console who has the highest BMI, together with the fullname
...
// } else {
//   console.log('Sorry guys, you are the 2 fats men!!!!!');
// };
...
// i = 10, 10 < 10 FALSE, exit to the loop !
...
is between $50 and $200and 10% if the bill is more than $200.
...
the tip calculator.
4. As an output, create 1) a new array containing all the tips, and 2) an array
...
Mark likes to tip 20% of the bill when the bill is less than $110 10% when the bill
is between $100 and $300, and 25% if the bill is more than $300 (different than John).

5. Implement the same functionnality as before, this time using Mark's tipping rules.
6. Create a function (not a method) to calculate the average of a given array
of tips. HINT: Loop over the array, and in each iteration store the current sum in a variable.
